...
<!-- head  -->
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            $("#comp_actions a").click(function(e) {
                                        ...
                                        <td class="text-center">
                                            <div class="list-icons">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" id="comp_actions">
                                                        
                                                        <a href="company_details.php?company_id=<?php echo $row["company_id"]; ?>" class="dropdown-item"><i class="mi-pageview mr-3 mi-1x"></i></i>Show</a>
                                                        <a href="company_delete.php" class="dropdown-item" comp_id="<?php echo $row["company_id"]; ?>"><i class="mi-delete mr-3 mi-1x"></i>Delete</a>
